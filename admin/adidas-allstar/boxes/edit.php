    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 mt-5">
          <h1 class="text-center">Edit Boxes</h1>
        ...
        <div class="col-md-5 mx-auto">
          <?php
              ...
              if (isset($_POST['update'])) {
                if (isset($_POST['name']) && isset($_POST['image_url']) && isset($_POST['paragraph'])) {
                     
                    $data['id'] = $id;
                    $data['name'] = $_POST['name'];
                    $data['image_url'] = $_POST['image_url'];
                    $data['paragraph'] = $_POST['paragraph'];
          ...
          <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="image_url" value="<?php echo $row['ImageURL']; ?>" class="form-control">
            </div>
            <div class="form-group">
                <label for="">Paragraph</label>
                <textarea name="paragraph" id="" cols="" rows="3" class="form-control"><?php echo $row['Paragraph']; ?></textarea>
            </div>
            <div class="form-group">
