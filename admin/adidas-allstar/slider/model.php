    ...
    class Model1{
        ...
        public function insert() {
            if (isset($_POST['submit'])) {
                ...
                $query = "INSERT INTO slider (Name1, ImageURL1, Paragraph1) VALUES (?, ?, ?)";
        ...
        public function edit($id) {
            $data = null;
            $stmt = $this->conn->prepare("SELECT * FROM slider WHERE id = ?");
        ...
        public function update($data){
            ...
            $query = "UPDATE slider SET Name1='$data[Name1]', ImageURL1='$data[ImageURL1]', Paragraph1='$data[Paragraph1]' WHERE id='$data[id] '";
